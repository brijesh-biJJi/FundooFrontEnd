           ...
           .subscribe(
             (archiveNote:any) =>{
              ...
              if (this.noteDetails != undefined) { 
                ...
                this.noteDetails.filter(archNote=>archNote.isPinned===false&&archNote.isArchived===true&&archNote.isTrashed===false );
                console.log('Note de',this.noteDetails.filter(archNote=>archNote.isPinned ===false&&archNote.isArchived === true&&archNote.isTrashed === false ));
